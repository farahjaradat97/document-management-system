...
const submit = (redirect) => {
    ...
    form.post(route("projects.storeFile", props.projectId), {
        onSuccess: () => {
            form.reset();
...
<template>
    <AuthenticatedLayout title="Upload File" :bread-crumbs="breadcrumbs.data">
        <template #content>
            <Toaster message='File uploaded successfully' v-if="showToaster"
            type="success"
            >
            ...
            >
                <div
                    class="w-full flex-col flex gap-6 bg-white border border-gray-200 mt-2 rounded-lg p-4"
                >
                    ...
                    <div class="w-full flex flex-col sm:flex-row gap-8">
                        <div class="sm:w-1/2 w-full">
                            ...
                            <TextInput
                                ...
                                required
                                class="w-full"
                                :message="form.errors.refrence_number"
                                v-model="form.refrence_number"
                                autofocus
                            />
                        </div>
                        <div class="sm:w-1/2 w-full">
                    ...
                    <div class="w-full flex flex-col sm:flex-row sm:pr-8">
                        <div class="sm:w-1/2 w-full">
                            ...
                            :project-id="projectId"
                                ...
                                :requiredError="requiredFileError"
                                @update="handleFileSelected"
                                @error="handelFileError"
                ...
                <div class="flex gap-2">
                    ...
                    >
                    <Link
                    :href="route('projects.folder', { id:projectId, folders:folder.path})"
                    >
                    <PrimaryButton class="mt-2" type="button" outlined
